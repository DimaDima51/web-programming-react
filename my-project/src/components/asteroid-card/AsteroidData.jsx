    ...
    return (
        <div className={`${styles.container} ${asteroidClass}`}>
            ...
            <div className={styles.info}>
                ...
                <div className={styles.row}> <span>Дата:</span> <span>{date}</span> </div>
                <div className={styles.row}> <span>Расстояние:</span>
                    <span>
                        {isKilometers 
                ...
                <div className={styles.row}> <span>Размер:</span> <span>{(diameter).toFixed(2)} м</span> </div>
            </div>
        </div>
    );
};